...
- Current milestone: **P1-M1 — Evidence Bundle v0.1 normative coherence** (`IN_PROGRESS`)
- Unique next action: **TP-PROTO-001 — Complete Evidence Bundle v0.1 normative field semantics**
