...
| R-005 | Cryptographic or canonicalization flaw undermines trust | Medium | Critical | Normative field registry, schema/verifier parity checks, deterministic vectors, second implementation, independent review, standard algorithms, domain separation | Any cross-implementation mismatch or signature ambiguity |
