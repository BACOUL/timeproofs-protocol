...
const requiredFiles = [
  ...
  'business/PRODUCT_VALIDATION_SPRINT.md',
  'evidence/market/COMPREHENSION_REPORT.md',
  'evidence/market/comprehension-report.json',
  'evidence/product/TP-DEMO-001_ACCEPTANCE.md',
